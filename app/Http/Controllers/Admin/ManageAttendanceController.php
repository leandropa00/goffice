...
class ManageAttendanceController extends AdminBaseController
{
    ...
    public function summaryData(Request $request)
    {
        ...
        foreach ($employees as $employee) {
            ...
            $emplolyeeName = '<div class="row"><div class="col-md-2 col-xs-4">' . $image . '</div><div class="col-md-10 col-xs-8"><a href="' . route('admin.employees.show', $employee->id) . '">' . ucwords($employee->name) . '</a></div></div>';

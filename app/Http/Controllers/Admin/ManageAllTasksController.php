...
class ManageAllTasksController extends AdminBaseController
{
    ...
    {
        $this->task = Task::with('users')->findOrFail($id)->withCustomFields();
    ...
    {
        $this->task = Task::with('board_column', 'subtasks', 'project', 'users', 'files', 'comments')->findOrFail($id)->withCustomFields();
        $this->fields = $this->task->getCustomFieldGroupsWithFields()->fields;

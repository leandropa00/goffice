        ...
        return cache()->remember(
            ...
            function () {
                return User::withoutGlobalScope('active')
                    ...
                    ->select('users.id', 'users.name', 'users.email', 'users.created_at', 'client_details.company_name', 'users.image')
    ...
    public static function allEmployees($exceptId = NULL)
    {
        if (!is_null($exceptId)) {
            $users = User::withoutGlobalScope('active')
                ...
                ->select('users.id', 'users.name', 'users.email', 'users.created_at', 'users.image', 'designations.name as designation_name')
                ->where('roles.name', '<>', 'client')

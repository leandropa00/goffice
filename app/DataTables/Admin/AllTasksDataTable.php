    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->editColumn('column_name', function ($row) use ($taskBoardColumns) {
                ...
                $status .= '<button aria-expanded="true" data-toggle="dropdown" class="btn dropdown-toggle waves-effect waves-light btn-xs"  style="border-color: ' . $row->label_color . '; color: ' . $row->label_color . '" type="button">' . $row->column_name . '</button>';

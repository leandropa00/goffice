...
class PaymentsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                $action .= '<li><a href="javascript:;" data-payment-id="' . $row->id . '" class="sa-params"><i class="fa fa-times" aria-hidden="true"></i> ' . trans('app.delete') . '</a></li>';
            ...
            ->editColumn('invoice_number', function ($row) {
                if ($row->invoice_id != null) {
                    return '<a href="' . route('admin.all-invoices.show', $row->id) . '">' . ucfirst($row->invoice->invoice_number) . '</a>';
                } else {
                    return '--';
                }
            })
    ...
    public function query(Payment $model)
    {
        ...
        $model = $model->orderBy('payments.id', 'desc');

...
class ProjectsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('client_id', function ($row) {
                ...
                return (!is_null($row->client->client_details) && $row->client->client_details->company_name != '') ? ucwords($row->client->name) . "<br>[" . $row->client->client_details->company_name . "]" : ucwords($row->client->name);
            })
    ...
    public function query(Project $model)
    {
        ...
        $model = $model->with('members', 'members.user', 'client', 'client.client_details', 'currency')->select('id', 'project_name', 'start_date', 'deadline', 'client_id', 'completion_percent', 'status', 'project_budget', 'currency_id');

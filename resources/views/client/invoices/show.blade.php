                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6 text-left">
                                    @if($invoice->recurring == 'no' && ($invoice->status == 'partial' || $invoice->status == 'unpaid') && ($credentials->paypal_status == 'active' || $credentials->stripe_status == 'active' || $credentials->razorpay_status == 'active'))

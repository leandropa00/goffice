                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="project_id" data-placeholder="@lang('app.selectProject')"  id="project_id_edit">
                                    ...
                                    @foreach($timeLogProjects as $tlproject)
                                        <option @if($timeLog->project && ($timeLog->project->id == $tlproject->id)) selected @endif value="{{ $tlproject->id }}">{{ ucwords($tlproject->project_name) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

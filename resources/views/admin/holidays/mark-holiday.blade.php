...
<script>
    ...
    function markHolidays(){
        swal({
            title: "Are you sure you want to mark selected days as holiday ?",
            text: "Note: This will mark all the selected days throughout the year as holiday. You will have to manually delete them once added.",
            type: "warning",

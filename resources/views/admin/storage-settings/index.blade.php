                                        ...
                                        <div class="col-sm-12 col-xs-12 ">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="label label-danger">@lang('app.note'):</label> Google Drive and Dropbox storage is deprecated. <a href="https://froiden.freshdesk.com/support/solutions/articles/43000559623-deprecated-google-drive-and-dropbox" class="font-bold" target="_blank">Click here to know more</a>
